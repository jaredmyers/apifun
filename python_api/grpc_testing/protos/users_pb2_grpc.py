...
class UsersStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUserStream = channel.unary_unary(
...
def add_UsersServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetUserStream': grpc.unary_unary_rpc_method_handler(
...
class Users(object):
    ...
    def GetUserStream(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/users.Users/GetUserStream',
